...
public class BaiduMapActivity extends AppCompatActivity implements AMapLocationListener ,LocationSource{
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        if (aMapLocation != null) {
            if (aMapLocation.getErrorCode() == 0) {
                ...
                Log.d(TAG, "onLocationChanged: "+stringBuffer.toString());
                showMsg(address);
